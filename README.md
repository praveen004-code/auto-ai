# auto-ai
This system automates complete data science workflow including preprocessing, model selection, hyperparameter optimization, and explainability using AutoML and Explainable AI.
import pandas as pd
